...
proto_qmi_setup() {
	...
	local device apn auth username password pincode delay modes cid pdh startdhcp metric defaultroute
	json_get_vars device apn auth username password pincode delay modes startdhcp metric defaultroute
