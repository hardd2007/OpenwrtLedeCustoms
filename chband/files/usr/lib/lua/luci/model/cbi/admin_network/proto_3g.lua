...
service:value("umts_only", "UMTS")
service:value("umts900_only", "UMTS 900")
service:value("umts2100_only", "UMTS 2100")
service:value("gprs_only", "GPRS")
service:value("gprs900_only", "GPRS 900")
service:value("gprs1800_only", "GPRS 1800")
service:value("lte_only", "LTE")
service:value("lte_b7_only", "LTE Band 7")
service:value("lte_b20_only", "LTE Band 20")
